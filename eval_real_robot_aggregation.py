...
def main(input, output, robot_ip, match_dataset, match_episode,
    ...
    with SharedMemoryManager() as shm_manager:
        with Spacemouse(shm_manager=shm_manager) as sm, RealEnv(
            ...
            camera_serial_numbers= ["cam_high", "cam_low", "cam_wrist"]) as env:
            cv2.setNumThreads(1)
            ...
            while True:
                ...
                try:
                    ...
                    all_time_actions = torch.zeros((history_length + 1, 4, 6))  # Shape: (history length, 4 actions, 6 eef positions)
